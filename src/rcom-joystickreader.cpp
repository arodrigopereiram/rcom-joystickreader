...
int main (int argc, char **argv)
{
	...
	printf("####  Alfredo Rodrigo Pereira Munoz - Programa de Prueba PS3 Controller  ####\n");
 ...
 */
	...
	if (!strcmp("--event", argv[1])) {
		...
		while (1) {
			...
			if ( js.type == 1 ) { //Pulsación de botón
				...
				printf("Información del joystick\n");
			}
		}
	}
